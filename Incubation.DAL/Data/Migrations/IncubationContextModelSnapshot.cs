...
namespace Incubation.DAL.Data.Migrations
{
    ...
    partial class IncubationContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Incubation.DAL.Entities.BookingAggregate.Booking", b =>
                {
                    ...
                    b.HasOne("Incubation.DAL.Entities.Bed", "BedData")
                        .WithMany("Bookings")
                        .HasForeignKey("bedid")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Incubation.DAL.Entities.BookingAggregate.ChildData", "ChildData")
                        .WithMany("bookings")
                        .HasForeignKey("childId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("BedData");
